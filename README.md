...
A complete written case study — business problem, methodology, all 5 findings with evidence, and recommendations — is available in [`/docs/Supermart_Case_Study.docx`](./docs/Supermart_Case_Study.docx).
